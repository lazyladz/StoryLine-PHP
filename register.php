...
<body>
        ...
        <div class="col-md-8 col-lg-6">
          <div class="auth-card card">
            <div class="card-body p-5">
              ...
              <form action="register.php" method="POST" id="signupForm" class="needs-validation" novalidate>
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
  ...
  <footer class="mt-5">
    <div class="container">
      <p>© 2023 Storyline. All rights reserved.</p>
      <p class="small">
...
<script>
  document.getElementById("signupForm").addEventListener("submit", function (e) {
    ...
    fetch("http://localhost/StoryLine%20Web/register.php", {
      method: "POST",
      ...
      .then(data => {
        ...
        alertDiv.className = data.success ? "alert alert-success alert-dismissible fade show" : "alert alert-danger alert-dismissible fade show";
        alertDiv.role = "alert";
        alertDiv.innerHTML = `
      ${data.message}
